...
namespace BrynStuff.Items.Weapons.Magic
{
    public class VolcanoWand : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Volcanic Wand");
            Tooltip.SetDefault("Shoots a bunch of sparks");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = ProjectileID.Spark; //idk why but all the guns in the vanilla source have this
            item.shootSpeed = 16f;
            item.mana = 3;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.GetItem("Death"), 20);
