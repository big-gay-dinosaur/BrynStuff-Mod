...
namespace BrynStuff.Projectiles.Minions
{
    ...
    public class ratSummonProjectile : HoverShooter
	{
		...
		public override void SetDefaults()
		{
			...
			inertia = 20f;
			shoot = ProjectileID.SolarWhipSword;
			shootSpeed = 12f;
		}
		...
		public override void CheckActive()
		{
			...
			if (player.dead)
			{
				modPlayer.ratSummonProjectile = false;
			}
			if (modPlayer.ratSummonProjectile)
		...
		public override void CreateDust()
		{
			if (projectile.ai[0] == 0f)
			{
				...
				{
					int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height / 2, DustType<FireDust>());
			...
			else
			{
				if (Main.rand.NextBool(3))
				{
					...
					int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustType<FireDust>());
